...
(function () {
  ...
  try {
    ...
    style.textContent = [
      ...
      "#psum-panel{position:fixed;bottom:96px;right:24px;z-index:2147483646;width:360px;max-width:calc(100vw - 32px);max-height:76vh;display:flex;flex-direction:column;background:#fff;border-radius:16px;box-shadow:0 24px 64px rgba(12,26,22,.28);overflow:hidden;font-family:system-ui,-apple-system,sans-serif;animation:psum-in .32s cubic-bezier(.2,.9,.3,1.15)}",
    ...
    function render() {
      ...
      panel.innerHTML =
        ...
        '<div id="psum-body"><div id="psum-meta"><span>' + pts.length + ' main points</span>' +
